...
See [next page](https://bpollner.github.io/uniset/example.html) for a practical example.
...
Go on and see what `uniset` can do in a [practical example](https://bpollner.github.io/uniset/example.html).
