...
Assuming you copied or moved the required files as [described before](https://bpollner.github.io/uniset/articles/uniset.html), open the RStudio project file in the folder 'dogPack' on your desktop, build and install the package, and then call:
